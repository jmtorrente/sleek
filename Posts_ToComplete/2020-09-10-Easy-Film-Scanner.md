...
* Film Development - In Spain, it is fairly easy and "inexpensive" to have your film developed (if it is a color film and not 120 format). In my case, my lab of trust, charges around 10€ for development + copies (10x15). If you want your film scanned (who does not..) then the prices rises for another 10€, if the film to be developed is monochrome prepare another 10€, because is not a common format nowadays.
